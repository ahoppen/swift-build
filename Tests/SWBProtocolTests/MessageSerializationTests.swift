...
@Suite fileprivate struct MessageSerializationTests {
    ...
    @Test func basicMessagesRoundTrip() throws {
        ...
        assertMsgPackMessageRoundTrip(WorkspaceInfoResponse(sessionHandle: "theSession", workspaceInfo: .init(targetInfos: [.init(guid: "theGuid", targetName: "aTarget", projectName: "aProject")], buildConfigurations: ["Debug", "Release"])))
